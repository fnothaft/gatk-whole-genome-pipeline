...
export ADAM_OPTS="--master yarn-cluster --num-executors 1024 --executor-memory 11g --executor-cores 1 --driver-memory 14g --conf spark.yarn.executor.memoryOverhead=3072"
